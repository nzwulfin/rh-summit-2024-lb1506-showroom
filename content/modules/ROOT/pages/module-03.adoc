...
[source,bash]
----
touch config-qcow2.json
----

You can use the `Code editor` to make the following changes, you may need to click the refresh icon above the directory listing on the left side of the editor.
[source,json]
----
{
  "blueprint": {
