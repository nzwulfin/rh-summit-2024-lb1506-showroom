...
....
Nov 15 19:21:10 localhost.localdomain systemd[1]: Failed to start Caddy Quadlet.
Nov 15 19:21:10 localhost.localdomain systemd[1]: caddy.service: Scheduled restart job, restart counter is at 7.
Nov 15 19:21:10 localhost.localdomain systemd[1]: Stopped Caddy Quadlet.
Nov 15 19:21:10 localhost.localdomain systemd[1]: caddy.service: Start request repeated too quickly.
Nov 15 19:21:10 localhost.localdomain systemd[1]: caddy.service: Failed with result 'exit-code'.
Nov 15 19:21:10 localhost.localdomain systemd[1]: Failed to start Caddy Quadlet.
....

Check the journal to see why the unit failed.
[source,bash]
----
